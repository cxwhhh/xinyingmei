...
@Service
public class UKWarwickMatchingAlgorithm extends UKSingleSchoolMatchingAlgorithmBase {
    @Override
    ...
    protected List<String> getSchoolAliases() {
        return Arrays.asList("University of Warwick", "Warwick");
    }

    @Override
    protected String getAlgorithmStrategy() {
        return "UK_WARWICK_MATCHING_ALGORITHM";
    }
