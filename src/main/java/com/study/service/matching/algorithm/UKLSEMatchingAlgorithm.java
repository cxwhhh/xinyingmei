...
@Service
public class UKLSEMatchingAlgorithm extends UKSingleSchoolMatchingAlgorithmBase {
    @Override
    ...
    protected List<String> getSchoolAliases() {
        return Arrays.asList("London School of Economics and Political Science", "London School of Economics", "LSE");
    }

    @Override
    protected String getAlgorithmStrategy() {
        return "UK_LSE_MATCHING_ALGORITHM";
    }
    ...
    private static Double requiredGpaForGroup(String group, String degreeReq, String majorCategory) {
        ...
        if ("BUSINESS_ECON".equals(majorCategory)) {
            base += 2.0;
        } else if ("ECS_ENGINEERING".equals(majorCategory)) {
            base += 1.0;
        }
        return base;
    }
