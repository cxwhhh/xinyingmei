...
@Service
public class UKManchesterMatchingAlgorithm extends UKSingleSchoolMatchingAlgorithmBase {
    @Override
    ...
    protected List<String> getSchoolAliases() {
        return Arrays.asList("University of Manchester", "Manchester");
    }

    @Override
    protected String getAlgorithmStrategy() {
        return "UK_MANCHESTER_MATCHING_ALGORITHM";
    }
