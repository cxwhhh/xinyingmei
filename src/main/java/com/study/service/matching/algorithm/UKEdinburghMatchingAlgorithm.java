...
@Service
public class UKEdinburghMatchingAlgorithm extends UKSingleSchoolMatchingAlgorithmBase {
    @Override
    ...
    protected List<String> getSchoolAliases() {
        return Arrays.asList("University of Edinburgh", "Edinburgh");
    }

    @Override
    protected String getAlgorithmStrategy() {
        return "UK_EDINBURGH_MATCHING_ALGORITHM";
    }
